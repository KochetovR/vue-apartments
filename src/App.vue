...
export default defineComponent({
  ...
  computed: {
    filteredApartments(): IApartments[] {
      return this.filterByCityName(this.filterByPrice(this.apartments))
    }
  },
  methods: {
    filter(newFilters: IFilters) {
      console.log(newFilters);
      
      this.filters.city = newFilters.city
      this.filters.price = newFilters.price
    },
    filterByCityName(apartments: IApartments[]) {
      if(!this.filters.city) return apartments
      
      return apartments.filter((apartment: IApartments) => {
        return apartment.location.city === this.filters.city
      })
    },
    filterByPrice(apartments: IApartments[]) {
